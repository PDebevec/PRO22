...
namespace KličiMe
{
    internal class KličiMeException:ApplicationException
    {
        ...
        public KličiMeException(string sporočilo, Exception notranja) : base(sporočilo, notranja) { }
    }

    internal class TajniAgentException : ApplicationException
    {
        public TajniAgentException(string sporočilo) : base("Najden tajni agent " + sporočilo) { }
    }
}
